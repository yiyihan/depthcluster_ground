\hypertarget{classdepth__clustering_1_1LineDistDiffPrecomputed}{}\doxysection{depth\+\_\+clustering\+::Line\+Dist\+Diff\+Precomputed Class Reference}
\label{classdepth__clustering_1_1LineDistDiffPrecomputed}\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
...
\item 
\mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_a035909e1718ad9b54b9b4116bbb6c408}{Line\+Dist\+Diff\+Precomputed}} (const cv\+::\+Mat $\ast$source\+\_\+image, const \mbox{\hyperlink{classdepth__clustering_1_1ProjectionParams}{Projection\+Params}} $\ast$params)
\begin{DoxyCompactList}\small\item\em Precompute the angles to avoid losing time on that. \end{DoxyCompactList}\item 
float \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_ac505afaa537656af1bcc342ab1e910c4}{Diff\+At}} (const \mbox{\hyperlink{structdepth__clustering_1_1PixelCoord}{Pixel\+Coord}} \&from, const \mbox{\hyperlink{structdepth__clustering_1_1PixelCoord}{Pixel\+Coord}} \&to) const override
...
bool \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_ac3ce8196d5e6f49f3e3bdc3e3b32b033}{Satisfies\+Threshold}} (float angle, float threshold) const override
...
cv\+::\+Mat \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_a77c9cf3bea954f13cd2fef4f8a182425}{Visualize}} () const
...
void \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_a9e52e2a94d9f92567953a765475d62a0}{Pre\+Compute\+Alpha\+Vecs}} ()
\begin{DoxyCompactList}\small\item\em Pre-\/compute values for angles for all cols and rows. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_a9d0211af30be1f60ef4e8db570128a7b}{Pre\+Compute\+Line\+Dists}} ()
...
float \mbox{\hyperlink{classdepth__clustering_1_1LineDistDiffPrecomputed_a2725113f6eb03b937104f325adf0c7aa}{Get\+Line\+Dist}} (float alpha, float current\+\_\+depth, float neighbor\+\_\+depth) const
...
const \mbox{\hyperlink{classdepth__clustering_1_1ProjectionParams}{Projection\+Params}} $\ast$ {\bfseries \+\_\+params} = nullptr
\item 
...
\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}!LineDistDiffPrecomputed@{LineDistDiffPrecomputed}}
\index{LineDistDiffPrecomputed@{LineDistDiffPrecomputed}!depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
\doxysubsubsection{\texorpdfstring{LineDistDiffPrecomputed()}{LineDistDiffPrecomputed()}}
{\footnotesize\ttfamily depth\+\_\+clustering\+::\+Line\+Dist\+Diff\+Precomputed\+::\+Line\+Dist\+Diff\+Precomputed (\begin{DoxyParamCaption}\item[{const cv\+::\+Mat $\ast$}]{source\+\_\+image,  }\item[{const \mbox{\hyperlink{classdepth__clustering_1_1ProjectionParams}{Projection\+Params}} $\ast$}]{params }\end{DoxyParamCaption})}
...
\mbox{\texttt{ in}}  & {\em source\+\_\+image} & The source image \\
\hline
...
\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}!DiffAt@{DiffAt}}
\index{DiffAt@{DiffAt}!depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
\doxysubsubsection{\texorpdfstring{DiffAt()}{DiffAt()}}
{\footnotesize\ttfamily float depth\+\_\+clustering\+::\+Line\+Dist\+Diff\+Precomputed\+::\+Diff\+At (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{structdepth__clustering_1_1PixelCoord}{Pixel\+Coord}} \&}]{from,  }\item[{const \mbox{\hyperlink{structdepth__clustering_1_1PixelCoord}{Pixel\+Coord}} \&}]{to }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em from} & Pixel from which to compute difference \\
\hline
\mbox{\texttt{ in}}  & {\em to} & Pixel to which to compute difference\\
\hline
\end{DoxyParams}
...
Implements \mbox{\hyperlink{classdepth__clustering_1_1AbstractDiff_a06ba188d8d83d0e4bad66c833656c26d}{depth\+\_\+clustering\+::\+Abstract\+Diff}}.
...
\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}!GetLineDist@{GetLineDist}}
\index{GetLineDist@{GetLineDist}!depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
\doxysubsubsection{\texorpdfstring{GetLineDist()}{GetLineDist()}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em alpha} & The angle $\alpha$ between the beams. \\
\hline
\mbox{\texttt{ in}}  & {\em current\+\_\+depth} & The reading of the first beam in meters. \\
\hline
\mbox{\texttt{ in}}  & {\em neighbor\+\_\+depth} & The reading of the second beam in meters.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}!PreComputeLineDists@{PreComputeLineDists}}
\index{PreComputeLineDists@{PreComputeLineDists}!depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
\doxysubsubsection{\texorpdfstring{PreComputeLineDists()}{PreComputeLineDists()}}
...
\index{depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}!Visualize@{Visualize}}
\index{Visualize@{Visualize}!depth\_clustering::LineDistDiffPrecomputed@{depth\_clustering::LineDistDiffPrecomputed}}
...
Reimplemented from \mbox{\hyperlink{classdepth__clustering_1_1AbstractDiff_a45314bf711f35e53590af28bdfc45313}{depth\+\_\+clustering\+::\+Abstract\+Diff}}.



The documentation for this class was generated from the following files\+:\begin{DoxyCompactItemize}
\item 
/home/wyh/depthclustering/src/depth\+\_\+clustering/src/image\+\_\+labelers/diff\+\_\+helpers/line\+\_\+dist\+\_\+diff.\+h\item 
/home/wyh/depthclustering/src/depth\+\_\+clustering/src/image\+\_\+labelers/diff\+\_\+helpers/line\+\_\+dist\+\_\+diff.\+cpp\end{DoxyCompactItemize}
